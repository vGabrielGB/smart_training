    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cedula', models.CharField(blank=True, max_length=20, null=True, unique=True, verbose_name='Cédula de Identidad')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('peso_actual', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='Peso (kg)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('especialidad', models.CharField(help_text='Ej: Musculación, CrossFit, Cardio', max_length=100)),
